"""
Legacy email fetcher - now uses modular components
"""
...
def test_email_fetcher():
    """Test function for email fetcher"""
    ...
    try:
        ...
        for i, email_info in enumerate(emails[:3]):
            print(f"\n📧 Email {i+1}:")
...
if __name__ == "__main__":
    ...
    if args.test:
        ...
        print("Use --test to run the email fetcher test")
        print("Make sure to set EMAIL_ADDRESS and EMAIL_PASSWORD in your .env file") 